# Prompt de NotebookLM — Airbag y dispositivos pirotécnicos

Generado por `generador/prompt.py` desde `curriculo/ssc.yml` y
`unidades/ssc-airbag.yml`. **No lo edites a mano**: edita
...
|---|---|
| `airbag-1-componentes` | unidad de control, captadores, módulos, muelle de reloj, pretensores |
| `airbag-2-manipulacion` | desactivación, desmontaje, transporte, almacenamiento y achatarrado |
...
del cuaderno, sobre Airbag y dispositivos pirotécnicos. Escribes en español de
...
**4. MANIPULACIÓN Y SEGURIDAD**
Desactivación previa, tiempo de espera, herramienta específica, prohibiciones expresas y qué hacer si algo sale mal.
...
nombre. Estos no pueden faltar nunca: Misión, Principio de funcionamiento, Características, Comportamiento en avería, Cómo comprobarlo, Manipulación y seguridad, Objeto y alcance, Fundamento, Manipulación y seguridad, Desarrollo, Verificación final.
