### NOTA DE PROCESO — GESTIÓN DE SEÑALES SUPLEMENTARIAS EN LA REGULACIÓN DEL CLIMATIZADOR / FUNDAMENTO
...
📷 IMAGEN: Esquema de transmisión de señales suplementarias (th, v, n) entre el cuadro de instrumentos, la UCE del motor y la UCE del climatizador — Fuente: SEÑALES SUPLEMENTARIAS.pdf, pág. 50
...
💡 ¿Quieres que elaboremos un esquema de bloques sobre la red de señales entre unidades de control para explicarlo en la pizarra del taller?