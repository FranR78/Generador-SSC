...
## Fundamento
El sistema de climatización automática recopila datos de captación procedentes de diversos entornos del vehículo (habitáculo, salpicadero, conjunto A/C, motor térmico, circuito de calor y circuito de frío) para regular el funcionamiento de la instalación mediante una **tarjeta electrónica** o centralita. (págs. 1-7)

## Desarrollo
El funcionamiento global del sistema se estructura mediante las interacciones de sus entornos funcionales:
- **Habitáculo y salpicadero:** El aire impulsado sale por los difusores y se mezcla con el aire ambiente del habitáculo para alcanzar la temperatura de consigna. La calidad del aislamiento térmico, la temperatura inicial de las paredes y la conductividad térmica del salpicadero influyen directamente en el tiempo necesario para lograr la convergencia térmica.
...
- **Motor térmico y circuitos térmicos:** El motor térmico arrastra mediante correa el **compresor** y la bomba de líquido refrigerante. El circuito de calor aporta la energía térmica a través del radiador de calefacción.
- **Interacción de señales con la centralita:**
  ...
  - **Presostato:** Informa de la presión en el circuito de fluido frigorífico. Si es excesiva o demasiado baja, manda cortar el compresor; si excede de un cierto valor, conecta la **segunda velocidad del GMV** (electroventilador).
  ...
  - **Módulo de inyección:** Informa si se produce una aceleración brusca para cortar el compresor y no restar potencia al motor, e incrementa el régimen de ralentí cuando el compresor está conectado para evitar que el motor se cale. (págs. 1-7)
...
## Valores de trabajo
No documentado en fuentes. (págs. 6-8)
...
💡 **Siguiente paso:** Selecciona otro documento en el panel lateral si deseas procesar una nueva fuente del cuaderno.