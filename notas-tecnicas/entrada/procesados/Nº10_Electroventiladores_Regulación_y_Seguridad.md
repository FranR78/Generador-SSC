...
* **Control Combinado por Etapas (Sistemas Tradicionales):**
  ...
  * Vuelve a la 1.ª velocidad cuando la presión desciende de los 16 bar y la temperatura de motor cae por debajo de 99 °C.
...
* **Conmutador de Presión (Trinaria):** Presostato triple instalado en el tubo de alta o en el filtro deshidratador:
  * **Corte por Baja Presión:** Desconecta el compresor si \\(P < 2\text{ bar}\\) (evita el funcionamiento sin gas o con fugas).
  * **Conexión de Ventiladores:** Conecta la 2.ª velocidad al llegar a **16 bar**.
...
💡 ¿Te gustaría revisar los esquemas eléctricos de conexión de la caja de relés de los electroventiladores o resolver el cuestionario de autoevaluación incluido en esta unidad?