...
| :--- | :--- | :--- | :--- |
| **Sensor de Presión y Temp. del Agente Frigorífico** | **G395** | **LIN-Bus** \\(\rightarrow\\) UCE de Red de A Bordo **J519** | Mide la presión y temperatura del gas; envía sus valores a la J519, que los vuelca a la red CAN Confort para la J255. |
| **Sensor de Humedad del Aire / Parabrisas** | **G355** / **G458** | **LIN-Bus** \\(\rightarrow\\) UCE Central de Confort **J393** | Mide la humedad y temperatura en la luna para calcular el riesgo de empañamiento. |
| **Sensor de Temperatura Exterior** | **G17** | Conexión directa a UCE de Red de A Bordo **J519** | Mide la temperatura ambiente exterior. |
| **Sensor de Calidad del Aire** | **G238** | **LIN-Bus** \\(\rightarrow\\) UCE de Climatronic **J255** | Evalúa la presencia de contaminantes para activar la recirculación automática. |
| **Unidad de Control de Turbina de Aire Fresco** | **J126** | **LIN-Bus** \\(\rightarrow\\) UCE de Climatronic **J255** | Regula electrónicamente la velocidad de giro del soplador del habitáculo. |
| **Servomotores de Chapaletas** | — | **LIN-Bus** (en serie) \\(\rightarrow\\) UCE de Climatronic **J255** | Gobiernan la posición de las trampillas de mezcla, distribución y recirculación. |
...
💡 ¿Te gustaría comparar esta gestión eléctrica del Audi A5 con la del Audi A4 (SSP 409) o repasar los esquemas de diagnóstico de sensores mediante el lector de averías?