...
codigo: V42
fuente: "MOTOR TURBINA S. Cº interior.pdf"
paginas: "24"
...
## Misión
Forma un único conjunto con el transmisor de temperatura interior G56 y su misión es generar un flujo de aire continuo que atraviese el transmisor para poder registrar el valor de temperatura del habitáculo. (pág. 24)

📷 IMAGEN: Componentes del motor V42 mostrando la placa electrónica, el estator y la turbina con eje imantado (rotor) — Fuente: MOTOR TURBINA S. Cº interior.pdf, pág. 24
...
📷 IMAGEN: Esquema del envío de la señal de positivo desde la unidad del autoclima hacia la unidad del aire acondicionado y la unidad del motor — Fuente: MOTOR TURBINA S. Cº interior.pdf, pág. 24
...
COBERTURA: documento «MOTOR TURBINA S. Cº interior.pdf», páginas 24 a 24 de 24. completo