...
* **Función 01 (Versión de la UCE):** Identifica el programa activado. La unidad **J255** es idéntica para Autoclima y Calefacción Motorizada; detecta el equipamiento mediante un puente de codificación a masa en el contacto 21.
...
💡 ¿Te gustaría comparar las estrategias de autodiagnosis y esquemas de este Ibiza/Córdoba '99 con las de otros modelos del grupo VAG incluidos en tu cuaderno (como el Ibiza III ASY o el Audi A4)?