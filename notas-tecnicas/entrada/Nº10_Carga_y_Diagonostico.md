...
2. Método por proceso de recuperación (recomendado ante dudas de limpieza):
   ...
   - Cerrar la bombona exterior, purgar la manguera mediante la recicladora y cerrar ALTA.
...
2. Acelerar el motor entre 4.500 y 5.000 rpm durante 3 minutos con la calefacción y el aire acondicionado al máximo rendimiento, dirigiendo la mayor masa de aceite hacia el compresor.
...
4. Con las válvulas de la máquina cerradas, conectar los acoples de Alta y Baja a las tomas de servicio del vehículo.
...
## Verificación tras la reparación
Recuperar el refrigerante, reparar el componente defectuoso, efectuar el vacío, cargar la cantidad exacta de aceite nuevo y gas prescriptos y verificar la estabilización de presiones. (pág. 126)
