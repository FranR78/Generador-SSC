---
id: ssc.evaporador.el-evaporador
modulo: ssc
unidad: clima
nt: 747
tipo: elemento
...
marca: "Valeo"
fuentes: "EL EVAPORADOR.PDF, págs. 1-8"
...
- Diagrama psicrométrico de condensación de agua en aletas para aire a 35 ºC y 40% HR saliendo a 10 ºC y 100% HR — Fuente: EL EVAPORADOR.PDF, pág. 2 (pág. 2).
- Evolución del ciclo en el Diagrama de Mollier al sustituir el evaporador por uno de menor eficacia con caída de BP a BP' — Fuente: EL EVAPORADOR.PDF, pág. 5 (pág. 5).
