...
/** Reinicia los contadores de un alumno, para abrirle una tanda nueva. */
/** Cuenta una entrada del alumno al portal. */
function registrarConexion() { return db_conexion_(); }

/** Suma tiempo conectado; el front lo llama cada 30 s mientras la pestaña esté visible. */
